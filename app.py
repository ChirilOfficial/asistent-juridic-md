...
# =========================================================
# ⚠️ Pune ID-ul tău real din Google Drive între ghilimele
...
if not os.path.exists(DB_DIR):
    with st.spinner("🔍 Se descarcă baza de date juridică (se execută doar la prima pornire)..."):
        try:
            # Descarcă fișierul din Google Drive folosind ID-ul direct și modul fuzzy pentru fișiere mari
            gdown.download(id=GOOGLE_DRIVE_FILE_ID, output=ZIP_PATH, quiet=False, fuzzy=True)
            
            # Dezarhivare
            with zipfile.ZipFile(ZIP_PATH, 'r') as zip_ref:
                zip_ref.extractall(".")
            
            # Șterge arhiva zip după extragere pentru a elibera spațiul
...
# =========================================================
# 🔑 3. PRELUARE CHEIE API GROQ DIN SECRETS
# =========================================================
